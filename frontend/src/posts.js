const posts = [
    {
        ...
        Docker allows us to containerize our microservices, making deployment and scaling easier.  Dropwizard provides a convenient way to create RESTful APIs and integrates well with MongoDB. We'll demonstrate how to set up a Dropwizard project, define endpoints, and connect to a MongoDB database. 

         Docker will then be used to containerize each microservice, ensuring consistency across environments. By the end of this tutorial, you'll have a clear understanding of how to architect microservices using Dropwizard, MongoDB, and Docker. This setup enables rapid development and deployment of scalable microservices, making it ideal for modern applications.`
...
export  {posts, post2, post3, post4, post5, post6};